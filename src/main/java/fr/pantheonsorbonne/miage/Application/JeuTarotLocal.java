...
public class JeuTarotLocal extends TarotEngine {
    ...
    protected JeuTarotLocal(Deck deck, List<String> playerNames, int nombreDeManche) {
        ...
        for (String playerName : playerNames) {
            Player player = new DumbPlayer(playerName); // ou DumbPlayer si c'est ce que vous voulez
    ...
    public static void main(String... args) {
        TarotEngine localTarotGame = new JeuTarotLocal(new RandomDeck(), Arrays.asList("Adrian", "Nino", "Herbaut"),
                5);
        localTarotGame.play();
        System.exit(0);
    }
